...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="current">Recrutement</a> <a href="ajoutRecrutement.php"><i class="icon-edit"></i>Nouveau</a> </div>
            ...
            <table id="example" class="table display" style="width:100%;">
              ...
              <?php 
               ...
               {  
                 ...
                 echo '<a href="ajoutRecrutement.php?action=edit&idRecrutement='.$donnees['idRecrutement'].'"<i class="glyphicon glyphicon-edit"></i></a>';
                 echo '<a href="supprRecrutement.php?action=suppr&idRecrutement='.$donnees['idRecrutement'].'" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer cette entree?\'));"><i class="glyphicon glyphicon-trash"></i></a>';
                 echo '</td>'; 
                 echo '</tr>';
                $i++;
               }
