...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="current">Filiale</a> <a href="ajouter_filiale.php"><i class="icon-edit"></i>Nouveau</a> </div>
            ...
            <table id="example" class="table display" style="width:100%;">
              ...
              <?php 
               ...
               {  
	             ...
	             echo  '<td>'.$i.'</td>'; 
                 echo  '<td>'.$donnees['filialesigle'].'</td>'; 
                 echo  '<td>'.$donnees['filialenom'].'</td>';
                 echo  '<td>'.$donnees['filialeresponsable'].'</td>';
                 echo  '<td>'.$donnees['filialeadresse'].'</td>';
                 echo  '<td>'.$donnees['filialetel'].'</td>';
                 echo  '<td>';
                 //echo '<a href="#"><i class="icon icon-search"></i></a>';
                 echo '<a href="ajouter_filiale.php?action=edit&id='.$donnees['filialecode'].'"<i class="glyphicon glyphicon-edit"></i></a>';
                 echo '<a href="supprFiliale.php?action=suppr&id='.$donnees['filialecode'].'" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer cette entree?\'));"><i class="glyphicon glyphicon-trash"></i></a>';
                 echo '</td>'; 
                 echo '</tr>';
                $i++;
               }
