...
if (trim($_GET['action']) == 'edit')
    {
        ...
        $req = $bdd->prepare('SELECT *  FROM diplom WHERE idDiplom = ?');
...
$reponse = $bdd->query('SELECT * FROM diplom ORDER BY libelle ASC');
?>

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="diploms.php">Diploms</a> <a href="#" class="current"><i class="icon-edit"></i>Saisie Diplom</a> </div>
  ...
  <div class="row-fluid">
          ...
          <div class="widget-title">
            <span class="icon"><i class="icon-th"></i>Ajouter Diplom</span>   
