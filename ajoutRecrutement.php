...
if (trim($_GET['action']) == 'edit')
    {
        ...
        $req = $bdd->prepare('SELECT *  FROM recrutement WHERE idRecrutement = ?');
...
$reponse = $bdd->query('SELECT * FROM recrutement ORDER BY libelle ASC');
?>

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="recrutement.php">Recrutement</a> <a href="#" class="current"><i class="icon-edit"></i>Saisie Recrutement</a> </div>
  ...
  <div class="row-fluid">
          ...
          <div class="widget-title">
            <span class="icon"><i class="icon-th"></i>Ajouter Recrutement</span>   
             
          </div>	
			<div class="w3-container w3-white">
              <div class="w3-row-padding">
			  <form class="form-horizontal" method="post" action="actionAjoutRecrutement.php" name="basic_validate" id="basic_validate">
                                        <label>Lebelle</label>
                                            <input type="text" class="w3-input w3-border" name="libelle" id="libelle" value = "<?php echo $libelle; ?>" required>
                                              <input type="hidden" name="idRecrutement" value = "<?php echo $idRecrutement; ?>">
                                        <br/><br/>
										<a href="#" class="w3-bar-item w3-button w3-light-grey" style="width:49%;" onclick="location.href='recrutement.php'" >Retour</a>
