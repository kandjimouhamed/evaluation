...
include('header.php');
$reponse = $bdd->query('SELECT * FROM coefs ');
?>

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="current">Critere d'Evaluation</a> <a href="ajoutCoef.php"><i class="icon-edit"></i>Nouveau</a> </div>
