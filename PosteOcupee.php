...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="current">Posste Ocupee</a> <a href="AjoutPosteOcupee.php"><i class="icon-edit"></i>Nouveau</a> </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title">
            ...
            <h5>Liste des Postes Ocupees</h5>
          </div>
            ...
            <table id="example" class="table display" style="width:100%;">
              ...
              <?php
               ...
               while ($donnees = $reponse->fetch())
               {
                 ...
                 echo '<a href="ajoutPosteOcupee.php?action=edit&idPO='.$donnees['idPO'].'"<i class="glyphicon glyphicon-edit"></i></a>';
                 echo '<a href="suprPosteOcupee.php?action=suppr&idPO='.$donnees['idPO'].'" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer cette entree?\'));"><i class="glyphicon glyphicon-trash"></i></a>';
                 echo '</td>';
                 echo '</tr>';
                $i++;
               }
