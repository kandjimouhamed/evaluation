...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="current">Langue</a> <a href="AjoutLangue.php"><i class="icon-edit"></i>Nouveau</a> </div>
            ...
            <table id="example" class="table display" style="width:100%;">
              ...
              <?php
               ...
               while ($donnees = $reponse->fetch())
               {
                 ...
                 echo '<a href="suprLangue.php?action=suppr&idLangue='.$donnees['idLangue'].'" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer cette entree?\'));"><i class="glyphicon glyphicon-trash"></i></a>';
                 echo '</td>';
                 echo '</tr>';
                $i++;
               }
