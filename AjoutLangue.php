                    ...
                    <div class="w3-container w3-white">
                        <div class="w3-row-padding">
                            <form class="form-horizontal" method="post" action="actionAjoutLangue.php" name="basic_validate" id="basic_validate">
                                ...
                                <input type="text" class="w3-input w3-border" name="description" id="description" value = "<?php echo $description; ?>" required>
                                <input type="hidden" name="idLangue" value = "<?php echo $idLangue; ?>">
                                <br/><br/>
                                <a href="#" class="w3-bar-item w3-button w3-light-grey" style="width:49%;" onclick="location.href='langue.php'" >Retour</a>
