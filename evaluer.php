<?php
include('header.php');
$reponse = $bdd->query('SELECT * FROM evaluer ORDER BY id ASC');
?>

<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Retour" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="current">Entretient</a> <a href="ajoutEvalue.php"><i class="icon-edit"></i>Nouveau</a> </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-title">
                        ...
                        <h5>Liste des Salaries deja passe</h5>
                    </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table id="example" class="table display" style="width:100%;">
                            ...
                            while ($donnees = $reponse->fetch())
                            {
                                ...
                                echo '<a href="ajoutEvalue.php?action=edit&id='.$donnees['id'].'"<i class="glyphicon glyphicon-edit"></i></a> &nbsp; '; 
                                echo '<a href="supprFiliale.php?action=suppr&id='.$donnees['id'].'" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer cette entree?\'));"><i class="glyphicon glyphicon-trash"></i></a> &nbsp;';
                                echo '<a href="detaileSalarie.php?action=detail&id='.$donnees['id'].'"<i class="glyphicon glyphicon-eye-open"></i></a>';
                                echo '</td>';
                                echo '</tr>';
                                $i++;
                            }
