...
if (isset($_GET['idSalarie']))
{
  ...
  $_SESSION['idSalarie'] = $idSalarie;
    ...
    if (trim($_GET['action']) == 'edit')
    {
        ...
        {
            $_SESSION['idSalarie'] = $donnees['idSalarie'];
                           ...
                           <input type="submit" name="valider" class="btn btn-success redrecrtion" value="insert" />
                            ...
                            <table class="table">
                              ...
                              <?php
                                    ...
                                    <td> <?=$a['ecole']?></td>
                                    <td>  <a href="suppInsertion.php?action=suppr&idDipSala=<?=$a['id']?>" onclick="return(confirm('Etes-vous sur de vouloir supprimer cette entree?'));"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                                    </tr>
                                    </tbody>
