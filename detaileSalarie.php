                    ...
                    <div class="w3-row-padding">
                        ...
                        <form class="form-horizontal" method="post" action="action_AjoutSalarie.php" name="basic_validate" id="basic_validate">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                <label>Prenom</label>
                                <input type="text" class="w3-input w3-border" name="prenom" id="prenom" value = "<?php echo $prenom; ?> " required disabled>
                                <input type="hidden" name="idSalarie" value = "<?php echo $idSalarie; ?>">
                              
                                <label>Nom</label>
                                <input type="text" class="w3-input w3-border" name="nom" id="nom" value = "<?php echo $nom; ?>" required disabled>
                                <input type="hidden" name="idSalarie" value = "<?php echo $idSalarie; ?>">
                               
                                <label>Fonction Actuelle</label>
                                <input type="text" class="w3-input w3-border" name="fonctionActuelle" id="fonctionActuelle" value = "<?php echo $fonctionActuelle; ?>" required disabled >
                                <input type="hidden" name="idSalarie" value = "<?php echo $idSalarie; ?>">

                          
                                <label>Ancienete dans la Fonction</label>
                                <input type="text" class="w3-input w3-border" name="ancieneteFonc" id="ancieneteFonc" value = "<?php echo $ancieneteFonc; ?>" required disabled>
                                <input type="hidden" name="idSalarie" value = "<?php echo $idSalarie; ?>">
                               
                            <br>
                                <div >
                                <label>Situation Fammilialle</label>      
                                 <select name="situationFam" id="situationFam"  style="width:100%;" size="1" value = "<?php echo $situationFam; ?>"  class="mt-3 w3-input w3-border form-group" size="1" required disabled>
                              ...
                              <div>
                                ...
                                <br>      
                                 <select name="telephone" id="telephone"  style="width:100%;" size="1" value = "<?php echo $telephone; ?>"  class="w3-select w3-border" size="1" required disabled>
                         ...
                         <div>
                                <label>carburant</label>      
                                 <select name="carburant" id="carburant"  style="width:100%; height:100px;" size="1" value = "<?php echo $carburant; ?>"  class="mt-3 w3-select w3-border" size="1" required disabled>
                               ...
                               <br>
                                ...
                                <label>commussion</label>      
                                 <select name="commussion" id="commussion"  style="width:100%;" size="1" value = "<?php echo $commussion; ?>"  class="w3-select w3-border" size="1" required disabled>
                                ...
                                <label>vehicule</label>      
                                 <select name="vehicule" id="vehicule"  style="width:100%;" size="1" value = "<?php echo $vehicule; ?>"  class="w3-select w3-border" size="1" required disabled>
                                ...
                                <br/>
                                <label>Autres</label>
                                <input type="text" class="w3-input w3-border" name="autres" id="autres" value = "<?php echo $autres; ?>" required disabled>
                                <input type="hidden" name="idSalarie" value = "<?php echo $idSalarie; ?>">
                                <br/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="w3-input w3-border" name="dateNaiss" id="dateNaiss" value = "<?php echo $dateNaiss; ?>" required disabled>
                                    <input type="hidden" name="idSalarie" value = "<?php echo $idSalarie; ?>">
                                    <br/>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <select name="contrat" id="contrat"  style="width:100%;" size="1"  class="w3-select w3-border" size="1"  value = "<?php echo $contrat; ?>" required disabled>
                            ...
                            <div class="page">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select name="idDiplom" id="idDiplom" style="width:100%;" size="1"  class="w3-select w3-border" size="1" required disabled>
                                            <option>  </option>
                                            <?php
                                        ...
                                        <select name="idservice"  style="width:100%;" id="idservice" size="1" class="w3-select w3-border" size="1" required disabled>
                                            <option>  </option>
                                            <?php
                                        ...
                                        <select name="idParentel"  style="width:100%;" id="idParentel" size="1"  class="w3-select w3-border" size="1" required disabled>
                                            <option>  </option>
                                            <?php
                                        ...
                                        <select name="idPO" id="idPO"  style="width:100%;" size="1" class="w3-select w3-border" size="1" required disabled>
                                            <option>  </option>
                                            <?php
                                        ...
                                        <select name="idRecrutement"  style="width:100%;" id="idRecrutement" size="1"  class="w3-select w3-border" size="1" required disabled>
                                            <option>  </option>
                                            <?php
                                        ...
                                        <label>Langue</label>
                                        <select name="idlangue" id="idlangue"  style="width:100%;" size="1"  class="w3-select w3-border" size="1" required disabled>
                                            <option>  </option>
                                            <?php
                                ...
                                <button type="button"  class="w3-bar-item w3-button w3-light-grey" style="width:48%;" > <a href="salarie.php" style="color:black; text-decoration: none;">Fermer</a> </button><br/><br/>
